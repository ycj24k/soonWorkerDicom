<template>
  <div class="flex_box flex_col_top action_box">
    ...
    <div class="action_item">
      ...
      <div class="flex_box flex_row_center action_b">
        <div class="action_name action_name1">关于我们</div>
      </div>
    </div>
    ...
    <div class="flex_box flex_col_top action_items">
      ...
      <div class="action_item">
        <div class="flex_box flex_col_top action_btns">
          <div class="action_btn" :class="{ 'action_btn1': actionClick === 1 }" @mousedown="actionClick = 1"
            @mouseup="actionClick = 0" @click="$emit('toggle-grid-layout')">
      ...
      <div class="action_item">
        <div class="flex_box flex_col_top action_btns">
          <div @click="$emit('reset-viewport')" class="action_btn" :class="{ 'action_btn1': actionClick === 10 }"
      ...
      <div class="action_item">
        <div class="flex_box flex_col_top action_btns">
          <div @click="$emit('rotate-image', -90)" class="action_btn" :class="{ 'action_btn1': actionClick === 5 }"
            @mousedown="actionClick = 5" @mouseup="actionClick = 0">
            <img class="action_img" src="@/assets/images/action5.png" />
          </div>
          <div @click="$emit('rotate-image', 90)" class="action_btn" :class="{ 'action_btn1': actionClick === 6 }"
      ...
      <div class="action_item">
        <div class="flex_box flex_col_top action_btns">
          <div @click="$emit('flip-image', 'horizontal')" class="action_btn"
            :class="{ 'action_btn1': actionClick === 7 }" @mousedown="actionClick = 7" @mouseup="actionClick = 0">
            <img class="action_img" src="@/assets/images/action7.png" />
          </div>
          <div @click="$emit('flip-image', 'vertical')" class="action_btn" :class="{ 'action_btn1': actionClick === 8 }"
      ...
      <div class="action_item">
        <div class="flex_box flex_col_top action_btns">
          <div @click="$emit('fit-to-window')" class="action_btn" :class="{ 'action_btn1': actionClick === 9 }"
      ...
      <div class="action_item">
        <div class="flex_box flex_col_top action_btns">
          <div @click="$emit('invert-image')" class="action_btn" :class="{ 'action_btn1': actionClick === 24 }"
            @mousedown="actionClick = 24" @mouseup="actionClick = 0">
    ...
    <div class="flex_box flex_col_top action_items">
      <div class="action_item">
        <div class="flex_box flex_col_top action_btns">
          <div @click="$emit('activate-tool', { toolName: 'Zoom', actionId: 11 })" class="action_btn"
            :class="{ 'action_btn1': actionClick === 11 || activeAction === 11 }" @mousedown="actionClick = 11"
            @mouseup="actionClick = 0">
      ...
      <div class="action_item">
        <div class="flex_box flex_col_top action_btns">
          <div @click="$emit('activate-tool', { toolName: 'Pan', actionId: 12 })" class="action_btn"
            :class="{ 'action_btn1': actionClick === 12 || activeAction === 12 }" @mousedown="actionClick = 12"
            @mouseup="actionClick = 0">
      ...
      <div class="action_item">
        <div class="flex_box flex_col_top action_btns">
          <div @click="$emit('activate-tool', { toolName: 'Probe', actionId: 13 })" class="action_btn"
            :class="{ 'action_btn1': actionClick === 13 || activeAction === 13 }" @mousedown="actionClick = 13"
            @mouseup="actionClick = 0">
      ...
      <div class="action_item">
        <div class="flex_box flex_col_top action_btns">
          <el-popover v-model="cwShow" placement="bottom" trigger="manual"
            ...
            <div slot="reference" class="action_btn action_btn_wwwc"
              :class="{ 'action_btn1': actionClick === 14 || activeAction === 14 }" @mousedown="actionClick = 14"
              @mouseup="actionClick = 0" @click="handleWwwcButtonClick">
              <img class="action_img action_img1" src="@/assets/images/action14.png" />
              <img v-if="activeAction === 14 && active2 > 0 && active2 <= cwImgs.length"
                class="action_img action_img_overlay" :src="cwImgs[active2 - 1].img" />
            </div>
          </el-popover>
        </div>
        <div class="flex_box flex_row_center action_b">
      ...
      <div class="action_item playback-item">
        <div class="flex_box flex_col_top action_btns">
          <div @click="$emit('activate-tool', { toolName: 'StackScroll', actionId: 16 })" class="action_btn"
            :class="{ 'action_btn1': actionClick === 16 || activeAction === 16 }" @mousedown="actionClick = 16"
            @mouseup="actionClick = 0">
      ...
      <div class="action_item">
        <div class="flex_box flex_col_top action_btns">
          <div @click="$emit('activate-tool', { toolName: 'Length', actionId: 17 })" class="action_btn"
            :class="{ 'action_btn1': actionClick === 17 || activeAction === 17 }" @mousedown="actionClick = 17"
            @mouseup="actionClick = 0">
      ...
      <div class="action_item">
        <div class="flex_box flex_col_top action_btns">
          <div @click="$emit('show-image-info')" class="action_btn" :class="{ 'action_btn1': actionClick === 18 }"
            @mousedown="actionClick = 18" @mouseup="actionClick = 0">
            <img class="action_img" src="@/assets/images/action24.png" />
          </div>
        </div>
        <div class="flex_box flex_row_center action_b">
    ...
    <div class="flex_box flex_col_top action_items">
      ...
      <div class="action_item" v-if="false">
        <div class="flex_box flex_col_top action_btns">
          <div @click="$emit('clear-measurements')" class="action_btn" :class="{ 'action_btn1': actionClick === 19 }"
            @mousedown="actionClick = 19" @mouseup="actionClick = 0">
            <img class="action_img" src="@/assets/images/action19.png" />
          </div>
          <div @click="$emit('activate-tool', { toolName: 'Pan', actionId: 20 })" class="action_btn"
            :class="{ 'action_btn1': actionClick === 20 || activeAction === 20 }" @mousedown="actionClick = 20"
            @mouseup="actionClick = 0">
      ...
      <div class="action_item">
        <div class="flex_box flex_col_top action_btns">
          <div @click="$emit('activate-tool', { toolName: 'Length', actionId: 21 })" class="action_btn"
            :class="{ 'action_btn1': actionClick === 21 || activeAction === 21 }" @mousedown="actionClick = 21"
            @mouseup="actionClick = 0">
      ...
      <div class="action_item">
        <div class="flex_box flex_col_top action_btns">
          <div @click="$emit('activate-tool', { toolName: 'Angle', actionId: 22 })" class="action_btn"
            :class="{ 'action_btn1': actionClick === 22 || activeAction === 22 }" @mousedown="actionClick = 22"
            @mouseup="actionClick = 0">
      ...
      <div class="action_item">
        <div class="flex_box flex_col_top action_btns">
          <div @click="$emit('activate-tool', { toolName: 'RectangleRoi', actionId: 23 })" class="action_btn"
            :class="{ 'action_btn1': actionClick === 23 || activeAction === 23 }" @mousedown="actionClick = 23"
            @mouseup="actionClick = 0">
